...
function Newreleases({title}) {
	...
	if (isError || isLoading) {
		return (
			<div className="absolute top-0 left-0 w-full bg-opacity-[0.96] min-h-[100vh] lg:min-h-[59rem] z-[200] overflow-y-hidden  bg-black flex flex-col justify-center items-center ">
