...
function Header() {
	...
	return (
		<div className="flex items-center  p-2 flex-col fixed z-50 top-0 w-full md:flex-row md:items-center bg-gradient-to-b from-black to-gray-600">
			...
			<div className=" flex items-center w-[80%] lg:w-1/2 relative  h-auto justify-between ">
				<Input
					placeholder="SEARCH"
				...
				<div className=" relative text-white  flex items-center w-44 h-20    ">
					...
					>
						<AccountCircleIcon className=" hidden lg:block text-white  text-[10rem]" />
					</button>
					{showProfile && (
						<div className=" w-80 top-16 right-16 text-gray-900 bg-slate-200 rounded-lg min-h-[10rem] absolute">
							<h3 className="profileHover">sdfnkjjk</h3>
